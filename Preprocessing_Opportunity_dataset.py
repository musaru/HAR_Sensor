...
import h5py
import os
os.chdir('F:/PostDoctoral_Research/HAR/Sensor/Dataset/Opportunity/OpportunityUCIDataset/')
activities = {1: 'stand',
              2: 'walk',
              4: 'sit',
              5: 'lie',
...
if __name__ == "__main__":   
    ...
    X,y=segment_locomotion(df, window_size)
    npz_dir='F:/PostDoctoral_Research/HAR/Sensor/Dataset/Opportunity/'
    output_path = npz_dir + '/OpportunityLocomotion.npz'
